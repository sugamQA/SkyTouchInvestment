...
export default function Footer() {
  return (
    <footer className="relative z-10 overflow-hidden bg-gradient-to-br from-[#050b14] via-[#0a1628] to-[#0d1a30] text-white">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[700px] h-[700px] bg-blue-500/15 rounded-full blur-[150px] animate-pulse" />
        <div className="absolute bottom-0 right-1/3 w-[600px] h-[600px] bg-blue-600/15 rounded-full blur-[140px] animate-pulse" style={{ animationDuration: '6s' }} />
        <div className="absolute top-1/2 left-1/3 w-[500px] h-[500px] bg-blue-400/8 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/4 left-1/2 w-[300px] h-[300px] bg-blue-500/10 rounded-full blur-[100px] animate-pulse" style={{ animationDuration: '9s' }} />
        ...
        <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-b from-blue-500/8 via-transparent to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-blue-500/8 via-transparent to-transparent" />
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 pt-24 pb-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-[11px] tracking-[0.25em] font-bold text-white/90 mb-6 uppercase">Quick Links</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-[11px] tracking-[0.25em] font-bold text-white/90 mb-6 uppercase">Company</h4>
            <ul className="space-y-3">
            ...
            <ul className="space-y-4">
              ...
              <li className="group">
                <span className="flex items-start gap-3.5 text-sm text-white/70">
                  ...
                  <span>
                    <span className="block text-[10px] tracking-wider text-white/50 uppercase mb-0.5">Address</span>
                    <span className="text-white/80">Panipokhari, Kathmandu, Nepal</span>
                  </span>
                </span>
              </li>
            </ul>
            <div className="flex gap-3 mt-8">
              {socialLinks.map((s) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={s.label}
                  className={`w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-white/60 ${s.color} transition-all duration-300 hover:scale-110 border border-white/20 hover:border-white/40`}
                >
