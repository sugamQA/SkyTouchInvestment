  ...
  return (
    <>
      ...
      <div className={`relative flex items-center justify-center ${className}`}>
        <div
          className="relative w-[320px] h-[320px] rounded-full overflow-hidden shadow-[0_0_28px_rgba(255,255,255,0.22),-7px_0_10px_#c3f4ff_inset,18px_3px_28px_#000_inset,-28px_-2px_38px_#c3f4ff99_inset,300px_0_48px_#00000066_inset,180px_0_42px_#000000aa_inset]"
          style={{
