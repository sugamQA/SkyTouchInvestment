...
class Star {
    ...
    render(p, controller) {
        ...
        if (q > 0) {
            ...
            const dotSize = 12.5 * this.strokeWeightFactor * sizeMultiplier // Increased from 8.5 to 12.5
...
class AnimationController {
    constructor(canvas, ctx, dpr, size) {
        ...
        this.viewZoom = 100
        this.numberOfStars = 8000 // Increased from 5000
        this.trailLength = 120 // Increased from 80
    ...
    spiralPath(p) {
        ...
        const r = 220 * Math.sqrt(p) // Increased from 170 to 220
    ...
    drawTrail(t1) {
        for (let i = 0; i < this.trailLength; i++) {
            ...
            const sw = (2.2 * (1 - t1) + 5.0 * Math.sin(Math.PI * t1)) * f // Increased from 1.3 to 2.2 and 3.0 to 5.0
