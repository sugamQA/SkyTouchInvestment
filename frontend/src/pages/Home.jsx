...
const testimonials = [
  { quote: 'SkyTouch has been more than an investor; they have been true partners in our growth journey. When we needed capital to expand our multi-specialty hospital, they not only provided funding but brought governance expertise and strategic guidance.', name: 'Dr. Bishal Acharya', designation: 'Healthcare', src: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop&crop=face' },
  { quote: 'SkyTouch demonstrated deep understanding of our sector from day one. Their patient capital and strategic guidance helped us navigate regulatory complexities and scale our hydropower operations across multiple provinces.', name: 'Deepak Poudel', designation: 'Energy', src: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face' },
  { quote: 'In my 25 years in business, I have worked with various financial partners, but SkyTouch stands apart in their professionalism and long-term orientation. They brought governance best practices and strategic discipline that transformed our portfolio.', name: 'Suman Shakya', designation: 'Real Estate', src: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face' },
]
